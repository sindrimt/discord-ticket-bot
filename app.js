                ...
                setTimeout(() => {
                    ...
                    if (aiResponse) {
                        ...
                        const embed = new EmbedBuilder()
                            ...
                            .setTitle(
                                "Hi, I'm the Funding Pips AI Assistant. How may I help you? Just mention a keyword for assistance with your query."
                            )
                            .setDescription(aiResponse)
                            .setColor("#FFFFFF");
                        channel.send({ embeds: [embed] });
                        channel.send("I typically respond in under 30 seconds");
                    } else {
                        channel.send("**This ticket closes after 5 minutes of inactivity**");
